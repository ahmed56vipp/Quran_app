                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              // أيقونة مخصصة لنوع السورة (مكية/مدنية) من مجلد الـ icon الخاص بك
                              SizedBox(
                                width: 36,
                                height: 36,
                                child: Image.asset(
                                  ...
                                  fit: BoxFit.contain,
                                  errorWidget: (c, e, s) => const Icon(Icons.book, color: Colors.green),
                                ),
                              ),
...
class _SurahDetailScreenState extends State<SurahDetailScreen> {
  ...
  Future<Map<String, dynamic>> loadSurahData() async {
    ...
    if (widget.surahId == 1 || widget.surahId == 9) {
      ...
      // التحقق مما إذا كانت السورة تحتوي على بسملة مستقلة في الآية الأولى (مثل verse_0 أو verse_1 حسب السورة)
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontFamily: 'ahmed', // استخدام عائلة الخط المعرفة بملفك
